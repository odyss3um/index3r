  ...
  return (
    ...
    >
      <Popover open={props.isOpen} onOpenChange={props.onOpenChange}>
        ...
        <PopoverContent ref={contentRef} className="w-full bg-white">
      ...
      <div className={cn('-ml-2 mr-2 h-4 w-4', !showClearButton && 'hidden')}>
        <X
          className={cn('h-4 w-4 cursor-pointer text-primary/30', !jsDatetime && 'hidden')}
